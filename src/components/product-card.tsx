  ...
  return (
    <>
      <article
        ...
        className={`group surface-panel flex cursor-pointer flex-col overflow-hidden rounded-xl border transition-all duration-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#D3A94C] ${
          unavailable
      ...
      >
        ...
        <div className="flex flex-1 flex-col p-4 sm:p-5">
          ...
          <div className="mt-auto border-t border-[#1F443C]/8 pt-4">
